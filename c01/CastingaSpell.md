...
​    每项法术的描述的开头都是一组同类的信息，其中包括法术的名称、环阶、学派、施法时间、施法距离、法术成分和持续时间。余下的描述则具体说明该法术的相关效应。
...
- **死灵Necromancy**。死灵法术操纵生与死的能量。这些法术可以赋予额外的生命力，或从他人身上汲取生命能量，还可以创造不死生物，甚至起死回生。用死灵法术创造不死生物（如*操纵死尸animate  dead*）并不是善良的行径，只有邪恶的施法者者才会常用这些法术
...
- **受到伤害**。如果在进行专注时受到伤害，则你必须进行一次体质豁免，豁免成功则保持自己的专注。该豁免DC为10或所受伤害的一半，以两者中较高值为准。如果你所受伤害存在多个不同的来源，例如同时受到箭矢和龙息攻击，则你必须分别为每个伤害源各投一次豁免。
